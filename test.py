...
spec = S.ArraySpectrum(f['wave_micron'],f['flux_mjy'], waveunits='micron', fluxunits='ujy')
spec2 = S.ArraySpectrum(f['wave_micron'],f['flux_mjy']*1E8, waveunits='micron', fluxunits='ujy')
