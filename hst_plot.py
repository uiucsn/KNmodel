...
with open(f'n-events-exg.pickle', 'rb') as f:
...
axes[2].plot(h_range, ph, color='C1', linestyle='dotted', lw=3, zorder=2, label='Detection mag')
...
fig.savefig(f'HST_31_KN_plot.pdf')
plt.show()
